...
<DocsTextBlock className="m-b-medium-60">
  To dynamically generate design tokens on build-time with `@usefui/core`, you
  need to create a `ClientProvider` to handle your custom variables and
  distribute them as CSS variables.
</DocsTextBlock>
