...
<DocsTextBlock className="m-b-medium-60">
  **_If you are not planning to use the pre-built Design Token libraries_**,
  there are a few variables that must be defined in your `config` in order to
  get the expected behaviorfrom `useColorMode`.
</DocsTextBlock>
  ...
  properties={[
    {
      ...
      defaultValue:
        "{ light: 'var(--color-mono-darkest)'; dark: 'var(--color-mono-white)'; }",
      required: true,
    },
    {
      name: "body",
      type: "{ light: string; dark: string; }",
      defaultValue:
        "{ light: 'var(--color-mono-white)'; dark: 'var(--color-mono-darker)'; }",
      required: true,
    },
    {
      name: "contrast",
      type: "{ light: string; dark: string; }",
      defaultValue:
        "{ light: 'var(--color-mono-light)'; dark: 'var(--color-mono-dark)'; }",
      required: true,
    },
  ]}
/>
