...
<DocsPreview
  ...
  code={`import { Tabs, Divider } from "@usefui/components";
...
<DocsCodePreview
  language="tsx"
  code={`import { Tabs } from "@usefui/components";
...
<DocsFooter prev="/docs/components/table" next="/docs/components/textarea" />
